...
//R__LOAD_LIBRARY(/seaquest/users/mhossain/delete/AnaSimpleTree/build/libana_simple_tree.so)
...
/*
    // Process all events (input file specified here)
    outManager->ProcessEvents("input_file.root");
